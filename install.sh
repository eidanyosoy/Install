...
if [[ $(lsb_release -si) == "Debian" ]]; then
	...
	wget -qN https://raw.githubusercontent.com/eidanyosoy/Install/master/source/ansible-debian-ansible.list /etc/apt/sources.list.d/
...
##fast change the editions
echo -ne '#######                   (30%)\r'
git clone -b $edition --single-branch https://github.com/eidanyosoy/Install.git /opt/pgstage 1>/dev/null 2>&1
git clone https://github.com/eidanyosoy/PTS-Update.git /opt/ptsupdate 1>/dev/null 2>&1
echo -ne '##########                (40%)\r'
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
↘️  Update by Typing >>> sudo ptsupdate
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
EOF
}
###############
